define([
    ...
    function reviewRolling() {
        ...
        this.COLUMN_SIZE = 1; // 노출되는 컬럼 수
        this.DISPLAY_SIZE = 3; // 한페이지에 보여지는 컬럼 수
        this.COLUMN_HEIGHT = 55; // 페이지당 움직이는 수치
        this.isAnimate = false;

    }

    reviewRolling.prototype = {
        ...
        moveNext: function () {
            ...
            if (this.DISPLAY_SIZE != 1) {
                if (this.sceneCount >= this.PAGE_SIZE - (this.DISPLAY_SIZE - this.COLUMN_SIZE)) {
                    this.sceneCount = -1;
                }
            } else {
        ...
        bootStrap: function (opts) {
            ...
            this.PAGE_SIZE = Math.floor(this.FULL_SIZE / this.COLUMN_SIZE) - 1;
