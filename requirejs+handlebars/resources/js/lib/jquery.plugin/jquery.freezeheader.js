    ...
    $.fn.freezeHeader = function (params) {
        ...
        function freezeHeader(elem) {
            ...
            if (elem.length > 0 && elem[0].tagName.toLowerCase() == "table") {
                ...
                if (params && params.height !== undefined) {
                    if(params.hideScroll) {
                        obj.divScroll = '<div id="hdScroll' + obj.id + '" style="height: ' + params.height + '; overflow: hidden">';
                    } else {
                ...
                obj.scroller.on('scroll', function () {
                    ...
                    if (obj.header.position() != null) {
                        ...
                        if (limiteAlcancado(obj, params)) {
                            ...
                            if (($(document).scrollTop() > obj.header.position().top)) {
                                obj.container.css("position", "absolute");
                                obj.container.css("top", (obj.grid.find("tr:last").position().top - obj.header.height()) + "px");
                            }
                            else {
        ...
        function limiteAlcancado(obj, params) {
            if (params && (params.height !== undefined || params.scrollListenerEl !== undefined)) {
                return (obj.header.position().top <= obj.scroller.position().top);
            }
            else {
                var top = obj.header.position().top;
                if (params) {
                ...
                var gridHeight = (obj.grid.height() - obj.header.height() - obj.grid.find("tr:last").height()) + obj.header.position().top;
        ...
        function cloneHeaderRow(obj) {
            ...
            if (params && params.height !== undefined) {
                ...
                if(params.offset !== undefined){
                    ...
                    obj.container.css("top", obj.scroller.position().top + (params.offset.replace("px","") * 1) + "px");
                }
                else
                {
                    obj.container.css("top", obj.scroller.position().top + "px");
                }
