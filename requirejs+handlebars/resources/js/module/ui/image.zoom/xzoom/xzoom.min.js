 ...
 * Apache License 2.0
 *------------------------------------------------------*/
var styleLoader = document.createElement("link");
styleLoader.type = "text/css";
styleLoader.rel = "stylesheet";
styleLoader.href = '/static/js/renewal/module/ui/image.xzoom/xzoom.css';
document.getElementsByTagName("head")[0].appendChild(styleLoader);
